...
fullgen<- c()
for(g in levels(auto$genus)){
  if(length(levels(droplevels(auto$mode[auto$genus==g])))>1){
    fullgen <-append(fullgen,g)
  }
}
auto <- auto[auto$genus %in% fullgen,]
#==================================
#Manual dataset
...
line.host <- ggplot(data=m.host, aes(x=mode, y=host_spp, group=pair)) + 
  ...
  ylab("Number of host species") + xlab("") + annotate("text", x=1.5, y=75, label="p = 0.0042", size=4)+ylim(c(0,75))+geom_boxplot(aes(group=mode))
...
line.country <- ggplot(data=m.country, aes(x=mode, y=nbr_country, group=pair))+  
  geom_path(alpha=0.6) + theme_classic() + theme(axis.line.x = element_line (color="black"), axis.line.y = element_line (color="black")) +
  ylab("Number of countries") + xlab("") + annotate("text", x=1.5, y=100, label="p = 0.0046", size=4)+ylim(c(0,100))+geom_boxplot(aes(group=mode))
...
line.mindist <- ggplot(data=m.mindist, aes(x=mode, y=min_dist_eq, group=pair))+  
  geom_path(alpha=0.6) + theme_classic() + theme(axis.line.x = element_line (color="black"), axis.line.y = element_line (color="black")) +
  ylab("Minimum distance to equator") + xlab("") + annotate("text", x=1.5, y=40, label="p = 0.63", size=4) + geom_boxplot(aes(group=mode))
...
line.maxdist <- ggplot(data=m.maxdist, aes(x=mode, y=max_dist_eq, group=pair))+  
  geom_path(alpha=0.6) + theme_classic() + theme(axis.line.x = element_line (color="black"), axis.line.y = element_line (color="black")) +
  ylab("Maximum distance to equator") + xlab("") + annotate("text", x=1.5, y=75, label="p = 0.0078", size=4) + geom_boxplot(aes(group=mode))
...
grid.arrange(line.mindist,line.maxdist,nrow=1)
...
line.host <- ggplot(data=m.host, aes(x=mode, y=host_spp, group=genus)) + 
  geom_path(alpha=0.6) + theme_classic() + theme(axis.line.x = element_line (color="black"), axis.line.y = element_line (color="black")) +
  ylab("Number of host species") + xlab("") + annotate("text", x=1.5, y=150, label="p < 0.001", size=4)+geom_boxplot(aes(group=mode))+ylim(c(0,150))
...
line.country <- ggplot(data=m.country, aes(x=mode, y=nbr_country, group=genus))+
  geom_path(alpha=0.6) + theme_classic() + theme(axis.line.x = element_line (color="black"), axis.line.y = element_line (color="black")) +
  ylab("Number of countries") + xlab("") + annotate("text", x=1.5, y=90, label="p < 0.001", size=4)+geom_boxplot(aes(group=mode))
...
line.mindist <- ggplot(data=m.mindist, aes(x=mode, y=min_dist_eq, group=genus))+  
  geom_path(alpha=0.6) + theme_classic() + theme(axis.line.x = element_line (color="black"), axis.line.y = element_line (color="black")) +
  ylab("Minimum distance to equator") + xlab("") + annotate("text", x=1.5, y=50, label="p =0.01", size=4)+geom_boxplot(aes(group=mode))
...
line.maxdist <- ggplot(data=m.maxdist, aes(x=mode, y=max_dist_eq, group=genus))+  
  geom_path(alpha=0.6) + theme_classic() + theme(axis.line.x = element_line (color="black"), axis.line.y = element_line (color="black")) +
  ylab("Maximum distance to equator") + xlab("") + annotate("text", x=1.5, y=75, label="p = 0.001", size=4)+geom_boxplot(aes(group=mode))
...
line.latrange <- ggplot(data=m.latrange, aes(x=mode, y=lat_range, group=genus))+  
  geom_path(alpha=0.6) + theme_classic() + theme(axis.line.x = element_line (color="black"), axis.line.y = element_line (color="black")) +
  ylab("Latitude range") + xlab("") + annotate("text", x=1.5, y=120, label="p < 0.001", size=4)+geom_boxplot(aes(group=mode))
