...
fam = fam = ["Aphelinidae", "Encyrtidae", "Eulophidae", "Eupelmidae", "Eurytomidae", "Leucospidae", "Mymaridae", "Pteromalidae", "Torymidae", "Trichogrammatidae"]
...
my_genera = ["Anagrus", "Anagyrus", "Aphelinus", "Aphytis", "Arrhenophagus", "Baryscapus", "Bephratelloides", "Ceranisus", "Comperiella", "Copidosoma", "Encarsia", "Eretmocerus", "Eupelmus", "Ixidiphagus", "Leptocybe", "Leucospis", "Megastigmus", "Muscidifurax", "Neochrysocharis", "Pnigalio", "Protyndarichoides", "Pteromalus", "Tetrastichus", "Thripoctenus", "Trichilogaster", "Trichogramma"]
